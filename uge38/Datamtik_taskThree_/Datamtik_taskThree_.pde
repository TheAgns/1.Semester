...
void setup(){
firstTeacher= new Teacher("Thor",39,false);
firstStudent= new Student("Markus",22,false,"a");
secondStudent = new Student("Mustafa",20,false,"a");
println(firstTeacher.name, firstTeacher.age, firstTeacher.isFemale);
println(firstStudent.name, firstStudent.age, firstStudent.isFemale, firstStudent.datamatikerTeam);
println(secondStudent.name, secondStudent.age, secondStudent.isFemale, secondStudent.datamatikerTeam);
}
